...
class ScorepadView(ttk.Frame):
    ...
    def _create_widgets(self) -> None:
        ...
        for i, n in enumerate(numbers):
            btn = ttk.Button(self, text=str(n), command=lambda v=n: self._press_number(v))
            row = i // cols
            col = i % cols
        ...
        self.double_btn = ttk.Button(self, text="D")
        self.triple_btn = ttk.Button(self, text="T")
        self.bull25 = ttk.Button(self, text="25")
        self.bull50 = ttk.Button(self, text="50")
        self.miss = ttk.Button(self, text="Miss", style='Accent.TButton')
    ...
    def highlight_multiplier(self, multiplier: Multiplier) -> None:
        if multiplier == Multiplier.SINGLE:
            self.double_btn.state(['!pressed'])
            self.triple_btn.state(['!pressed'])
